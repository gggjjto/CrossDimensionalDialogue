...
class TestDataManager:
    ...
    def track_character_tag_map(
        self, character_tag_map: CharacterTagMap
    ) -> CharacterTagMap:
        """跟踪创建的角色标签关系"""
...
def create_test_character(
    ...
    **kwargs,
    ...
    character_data = CharacterCreate(
        name=name, short_bio=short_bio, persona_text=persona_text, **kwargs
    )
...
def create_test_tag(
    ...
    **kwargs,
    ...
    tag_data = CharacterTagCreate(name=name, description=description, **kwargs)
