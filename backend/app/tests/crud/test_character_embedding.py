...
class TestCharacterEmbeddingCRUD:
    ...
    def test_get_character_embeddings_with_type_filter(self, crud, mock_session):
        ...
        result = crud.get_character_embeddings(mock_session, character_id, embedding_type)
    ...
    def test_hybrid_search_characters(self, crud, mock_session):
        ...
        with patch.object(crud, 'text_search_characters', return_value=mock_text_results), \
             patch.object(crud, 'vector_search_characters', return_value=mock_vector_results):
