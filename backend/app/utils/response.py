...
class APIResponse:
    ...
    @staticmethod
    def success(data: Any = None, msg: str = "ok", code: int = 0) -> Dict[str, Any]:
        """
        成功响应
    ...
    @staticmethod
    def validation_error(errors: list, msg: str = "数据验证失败") -> Dict[str, Any]:
        """
        数据验证错误响应
        ...
        Returns:
            统一格式的响应字典
        """
        return {"code": 400, "msg": msg, "data": {"errors": errors}}

    @staticmethod
    def not_found(resource: str = "资源", msg: Optional[str] = None) -> Dict[str, Any]:
        """
        资源未找到响应
    ...
    @staticmethod
    def unauthorized(msg: str = "未授权访问") -> Dict[str, Any]:
        """
        未授权响应
    ...
    @staticmethod
    def forbidden(msg: str = "权限不足") -> Dict[str, Any]:
        """
        权限不足响应
    ...
    @staticmethod
    def server_error(msg: str = "服务器内部错误") -> Dict[str, Any]:
        """
        服务器错误响应
...
class GlobalExceptionHandler:
    ...
    async def http_exception_handler(
        ...
        if exc.status_code == 404:
            ...
            response_data = APIResponse.validation_error(
                errors=[exc.detail], msg="请求参数错误"
            )
        else:
            response_data = APIResponse.error(msg=exc.detail, code=exc.status_code)
    ...
    async def validation_exception_handler(
        ...
        response_data = APIResponse.validation_error(
            errors=formatted_errors, msg="请求参数验证失败"
        )
    ...
    async def pydantic_validation_exception_handler(
        ...
        response_data = APIResponse.validation_error(
            errors=formatted_errors, msg="数据模型验证失败"
        )
    ...
    async def general_exception_handler(
        ...
        response_data = APIResponse.server_error(msg="服务器内部错误，请稍后重试")
...
def success_response(
    data: Any = None, msg: str = "ok", code: int = 0
) -> Dict[str, Any]:
    """成功响应便捷函数"""
...
def error_response(
    msg: str = "error", code: int = 1, data: Any = None
) -> Dict[str, Any]:
    """错误响应便捷函数"""
...
def not_found_response(
    resource: str = "资源", msg: Optional[str] = None
) -> Dict[str, Any]:
    """未找到响应便捷函数"""
